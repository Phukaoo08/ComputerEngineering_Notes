...
<drawing version="7">
    ...
    <netlist>
        ...
        <block symbolname="gnd" name="XLXI_30(6:0)">
            <blockpin signalname="sum(15:9)" name="G" />
        </block>
        <block symbolname="acc8" name="XLXI_35">
            <blockpin name="ADD" />
            <blockpin name="B(7:0)" />
            <blockpin name="C" />
            <blockpin name="CE" />
        ...
        <block symbolname="acc8" name="XLXI_36">
            <blockpin name="ADD" />
            <blockpin name="B(7:0)" />
            <blockpin name="C" />
            <blockpin name="CE" />
    ...
    <sheet sheetnum="1" width="3520" height="2720">
        ...
        <iomarker fontsize="28" x="288" y="144" name="data(15:0)" orien="R180" />
        ...
        <branch name="sum(15:0)">
            <wire x2="2496" y1="128" y2="128" x1="2224" />
        </branch>
        <iomarker fontsize="28" x="2496" y="128" name="sum(15:0)" orien="R0" />
        <branch name="sum(7:0)">
            <attrtext style="alignment:SOFT-LEFT;fontsize:28;fontname:Arial" attrname="Name" x="1904" y="304" type="branch" />
            <wire x2="1904" y1="304" y2="304" x1="1712" />
        </branch>
        <branch name="sum(15:9)">
            <attrtext style="alignment:SOFT-LEFT;fontsize:28;fontname:Arial" attrname="Name" x="1664" y="624" type="branch" />
            <wire x2="1664" y1="624" y2="624" x1="1440" />
        </branch>
        <instance x="1376" y="752" name="XLXI_30(6:0)" orien="R0" />
        <instance x="2288" y="1040" name="XLXI_35" orien="R0" />
        <instance x="448" y="1072" name="XLXI_36" orien="R0" />
    </sheet>
</drawing>